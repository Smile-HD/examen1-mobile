...
void main() async {
  ...
  await PushNotificationsService.setupFirebaseForPush();
  final initialSession = await SessionStorage.loadSession();
  runApp(MyApp(initialSession: initialSession));
}

class MyApp extends StatelessWidget {
  final PersistedSession? initialSession;
